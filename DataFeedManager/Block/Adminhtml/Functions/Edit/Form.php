    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => 'Php script',
                'required' => false,
                'note' => "Example : <br><pre>function <b>example</b>(\$self,\$argument_1,\$argument_2){<br>" . "&nbsp;&nbsp;&nbsp;&nbsp;... do something with the arguments...<br>" . "&nbsp;&nbsp;&nbsp;&nbsp;return \$something;<br>" . "}</pre><br>" . "This custom function can be used in the template as follows: <br>" . "<pre>{{any.variable output=\"<b>example</b>(\$self,'value 1','value 2')\"}}</pre>",
            ]
        );
