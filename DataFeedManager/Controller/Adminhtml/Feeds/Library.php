...
class Library extends \Wyomind\DataFeedManager\Controller\Adminhtml\Feeds\AbstractFeeds
{
    ...
    public function execute()
    {
        try {
            ...
            $tabOutput .= " <li><a target='_blank' href='https://www.wyomind.com/magento2/data-feed-manager-magento.html#attribute-specifications-doc36'>" . __("Attributes") . "</a></li>";
            $tabOutput .= " <li><a target='_blank' href='https://www.wyomind.com/magento2/data-feed-manager-magento.html?section=userguide#basic-functions-doc106'>" . __("Functions") . "</a></li>";
            $tabOutput .= " <li><a target='_blank' href='https://www.wyomind.com/magento2/data-feed-manager-magento.html?section=userguide'>" . __("More documentation") . "</a></li>";
            $tabOutput .= '</ul>';
